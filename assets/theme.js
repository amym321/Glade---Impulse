...
(function($){
  ...
  theme.Product = (function() {
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      updateVariantImage: function(evt) {
        ...
        (typeof variant_images!='object') && this.$mainSlider.slick('slickGoTo', imageIndex);
      },
 ...
 jQuery(function($) {
    ...
    VIG.VariantChangeCallback = function(){
      ...
      /* Changing the data-index attributes works best instead of manually trying to change the slides after filtering the slides */
 setTimeout(function(){ 
        $('.product__thumb-item').each(function(index){
      	...
      	$('.product__main-photos .slick-slide').each(function(index){
        		$(this).attr('data-index', index);
          		$(this).attr('data-slick-index', index);
        });
        
        $('.product__thumb-item').first().click(); 
        $('.product__thumbs .slick-track').css('transform', 'none');
                           }, 200);
...
if($('.color-swatch-control').length>0){
  $('.color-swatch-control').on('click', function(e){
  	e.preventDefault();
    
    $(this).find('span').toggleClass('plus minus');
    
    if($(this).find('span').hasClass('plus')){
    	$(this).parents('.grid-product__colors').removeClass('color-swatch-more-active');
    }
    else{
    	$(this).parents('.grid-product__colors').addClass('color-swatch-more-active');
    }
